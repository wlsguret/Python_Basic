...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요",\
        ...
        initialdir=r"C:\Users\USER\Desktop\PythonWorkspace") 
        # 최초에 사용자가 지정한 경로를 보여줌 -> r"C:/~"
...
def del_file():
    ...
    for index in reversed(list_file.curselection()):
        # print(list(reversed(list_file.curselection())))
...
def  merge_image():
    try:
        ...
        #  100? = 80 * 60
        # ? = 80 * 60 / 100
        # size[0] : size[1] = img_width : ?
        # ? = img_width * size[1] / size[0]
